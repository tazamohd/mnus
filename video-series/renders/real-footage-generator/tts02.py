...
# العامية البيضاء البسيطة — ألفاظ يقرأها الصوت الآلي بشكل صحيح
LINES = [
    (0.6, 7.6,  'يا هلا! حاب تجرب سالس أوتو؟ الموضوع بسيط — مبسّطين الحكاية.'),
    (8.4, 19.6, 'في حسابات تجريبية مجانية — هذي القائمة: كل دور له حساب، وكلمة المرور واحدة، والنظام يكتبها لك تلقائياً. صوّرها عندك.'),
    (20.4, 25.6,'افتح موقع سالس أوتو دوت آب، واضغط على تسجيل الدخول.'),
    (26.4, 35.6,'في حساب تجريبي لكل دور — اختر الحساب اللي يناسبك واضغط عليه، وراح يكتب لك الإيميل وكلمة المرور تلقائياً.'),
    (36.4, 45.6,'اضغط تسجيل الدخول… لاحظ؟ النظام عرف دورك مباشرة وفتح لك لوحة التحكم الخاصة فيك.'),
    (46.4, 52.6,'هذي لوحة التحكم — الإيرادات والأعمال والعملاء والمخزون، كل شيء بالعربي وجاهز.'),
    (53.4, 64.6,'حاب تجرب دور ثاني؟ سجّل خروج، وارجع اضغط على فني — نفس الطريقة، وكل دور له شاشته.'),
    (65.4, 73.5,'وهذا كل شيء! جرّبها الآن على سالس أوتو دوت آب. بالتوفيق!'),
]
